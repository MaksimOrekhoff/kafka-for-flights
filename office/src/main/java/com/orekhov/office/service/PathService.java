package com.orekhov.office.service;

import com.orekhov.common.bean.Route;
import com.orekhov.common.bean.RoutePath;
import com.orekhov.common.bean.RoutePoint;
...
public class PathService {
    ...
    public Route convertLocationsToRoute(List<String> locations) {
        ...
        locations.forEach(location -> airPortsProvider.getPorts().stream()
